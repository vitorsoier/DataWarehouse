...
class ApiCollector:
    ...
    def getData(self, param):
        try:
            ...
            self.logger.info(
                f"Obtencao de dados realizada com sucecsso "
                + datetime.now().strftime("%Y-%h-%d-%H:%M:%S")
            )
        except:
            self.logger.warning(
                f"Obtencao de dados falhou "
                + datetime.now().strftime("%Y-%h-%d-%H:%M:%S")
            )
        return response
    ...
    def transformDf(self, response):
        try:
            ...
            self.logger.info(
                f"DF criado com sucecsso "
                + datetime.now().strftime("%Y-%h-%d-%H:%M:%S")
            )
        except:
            self.logger.warning(
                f"Criacao DF falhou " + datetime.now().strftime("%Y-%h-%d-%H:%M:%S")
            )
        return result
